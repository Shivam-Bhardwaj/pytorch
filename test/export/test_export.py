...
graph():
    ...
    def test_dynamic_lstm(self):
        ...
        with register_lstm_while_loop_decomposition():
            ep_bi = export(model_bi, (x, h0_bi, c0_bi), dynamic_shapes=dynamic_shapes_bi)
        ...
        with register_lstm_while_loop_decomposition():
            ep_multi = export(
                model_multi, (x, h0_multi, c0_multi), dynamic_shapes=dynamic_shapes_multi
            )
        ...
        with register_gru_while_loop_decomposition():
            ep_bigru = export(model_bigru, (x, h0_bi), dynamic_shapes=dynamic_shapes_bigru)
