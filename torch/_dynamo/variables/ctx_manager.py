...
class FxTracebackAnnotateBaseVariable(ContextWrappingVariable):
    """
    Base class for fx.traceback annotation context managers (annotate and annotate_scope).
...
class FxTracebackAnnotateScopeVariable(FxTracebackAnnotateBaseVariable):
    """
    fx.traceback.annotate_scope is a context manager that allows users to annotate the
    fx graph nodes with scope metadata.
    """
